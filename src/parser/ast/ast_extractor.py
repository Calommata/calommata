...
from .block import CodeBlock, BlockFactory, BlockParentResolver
from .dependency_extractor import DependencyExtractor

logger = logging.getLogger(__name__)


def compile_queries(language: Language, queries: dict[str, str]) -> dict[str, Query]:
...
class ASTExtractor:
    ...
    def __init__(self, language: Language, queries: dict[str, str]):
        ...
        self.compiled_queries = compile_queries(language, queries)
